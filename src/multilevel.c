 ...
 * itself is a separate file shared by all parameter sets. The single-level shims do the same
 * thing for the default build; see capability_x86_64.c and capability_aarch64.c for what
 * each architecture is actually checking. */
