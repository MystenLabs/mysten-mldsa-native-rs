 ...
 * machinery. We have no libcrypto to borrow from, so ours points at a standalone probe
 * instead (capability_x86_64.c, capability_aarch64.c). Same hook, different backing
 * implementation; no AWS-LC code is directly used in this crate.
 */
